...
//  MVVM-MovieApp
//
//  Created by Barış Sucuoğlu on 30.12.2023.
//
...
class AlertVC: UIViewController {
    ...
    let containerView = AlertContainerView(frame: .zero)
    let titleLabel = TitleLabel(textAlignment: .center, fontSize: 16)
    let messageLabel = BodyLabel(textAlignment: .center)
    let actionButton = AppButton(color: .systemPink, title: "Ok", systemImageName: "checkmark.circle")
